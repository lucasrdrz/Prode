...
#st.write("Columnas PARTIDOS:", partidos.columns)
#st.write("Columnas PREDICCIONES:", predicciones.columns)
# Mostrar partidos
...
# Calcular puntos
df["Puntos"] = (df["Prediccion"] == df["Resultado"]).astype(int)

# Ranking
tabla = df.groupby("Usuario")["Puntos"].sum().reset_index()
